  ...
  projects: [
    {
      ...
      liveLink: "",
      links: [{ linkName: "GitHub", link: "https://github.com/" }],
      start_date: "2022-06",
      end_date: "2022-07",
      description:
        "<ul><li>Collaborated in a dynamic two-person team, driving backend development for a hostel entry/exit mobile app.</li><li>Implemented cutting-edge barcode technology, fostering a collaborative effort that resulted in a 25% reduction in manual entry/exit time and a transformative enhancement in operational efficiency.</li><li>Automated registration number retrieval by integrating barcoded student identity cards, optimizing efficiency.</li></ul>",
      technologies: "React Native, Express.js",
    },
    {
      name: "Medicare",
      liveLink: "https://emed.onrender.com/",
      links: [{ linkName: "project", link: "https://emed.onrender.com/" }],
      start_date: "2021-12",
      end_date: "2022-02",
      description:
        "<ul><li>Developed an online medical consultancy web app facilitating patient-doctor communication while ensuring privacy.</li><li> Implemented features for easy signup using Google mail IDs, online appointment booking, video and chat consultations, and secure online payments.</li></ul>",
      technologies:
        "HTML, CSS, JavaScript, Materialize CSS, Express.js (Node.js)",
    },
  ],
  education: [
    {
